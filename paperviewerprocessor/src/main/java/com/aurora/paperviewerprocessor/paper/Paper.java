...
public class Paper extends PluginObject {
    ...
    private static final Section DUMMY_SECTION1 = new Section("Introduction", "Software security is becoming " +
            ...
            " However, these languages do not provide many  security  guarantees,  which  makes  many  of" +
            ...
            "this paper will be on techniques that operate on the binary file only, stripped of any debugging information." +
            "<br><br>" +
            ...
            "First, people often do not have access to the sourcecode of the programs they use. Using tools that " +
            "only need binary files, they can still check for vulnerabilities in these programs. When they " +
    ...
    private static final Section DUMMY_SECTION2 = new Section("Fuzzing", "Fuzzing (also called fuzz testing) can be defined as: " +
