...
public class Paper extends PluginObject {
    ...
    public List<Section> getSections() {
        ...
        Section sect1 = new Section("Introduction", "Software security is becoming " +
                ...
                " prone to bugs and vulnerabilities. Software testing and finding bugs has been a manual task for a long time, " +
                ...
                " and the source code. This discrepancy between source and binarycode can occur because different " +
        ...
        Section sect2 = new Section("Fuzzing", "Fuzzing (also called fuzz testing) can be defined as: " +
                ...
                "exploitable vulnerabilities” [13].Fuzzing on its own is simple: supply some random data at the input, " +
                "and wait until the software crashes. The hard (and creative) part is to generate inputs that trigger " +
                "errors in the program. The dotted box " +
                "encapsulates what is contained within a fuzzer. A fuzzer works as follows [12]: first, the user specifies" +
                " a target program(the program that needs testing) and optionally submits a seed file or specification. Second, " +
                "one of two things happens: 1) The code passes through the monitor which analyses the input and tries to " +
                ...
                "uzzer. The power of blackbox fuzzing lies in the fact that it works fast and is simpleto use. But there is" +
